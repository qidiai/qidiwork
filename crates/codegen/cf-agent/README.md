...
in `.qidi/agents/` (project-level) or `~/.qidi/agents/` (user-level).
...
let def = AgentDefinition::from_file(".qidi/agents/code-reviewer.md")?;
...
// Find all .md files in .qidi/agents/ directories
