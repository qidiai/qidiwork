...
//! 2. `$QIDI_HOME/managed_config.toml`

//! 3. `$QIDI_HOME/config.toml`

//! 4. `$QIDI_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
...
pub mod types;
pub mod xai_grok_config_types;

// Re-export the old xai-grok-config-types crate as a module alias for compatibility.
// This allows existing `use cf_config_types::*` imports to keep working.
