...
pub(crate) fn git_command() -> Command {
    ...
    cmd.envs(cf_tty_utils::pager_env());
...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + QIDI_HOME → private tmp + restore).
        ...
        // global QIDI_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since QIDI_HOME is process-global.
