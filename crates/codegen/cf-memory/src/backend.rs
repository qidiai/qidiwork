...
use cf_tools::types::memory_backend::{MemoryBackend, MemorySearchResult};
...
pub struct MemoryBackendParams {
    ...
    pub embed_config: Option<cf_config::xai_grok_config_types::MemoryEmbeddingConfig>,
    ...
    pub search_config: cf_config::xai_grok_config_types::MemorySearchConfig,
    ...
    pub auth_credentials: Option<Arc<dyn cf_auth::AuthCredentialProvider>>,
}
...
async fn build_embedding_provider(
    config: Option<&cf_config::xai_grok_config_types::MemoryEmbeddingConfig>,
    auth_credentials: Option<&Arc<dyn cf_auth::AuthCredentialProvider>>,
...
pub struct MemoryBackendImpl {
    ...
    embed_config: Option<cf_config::xai_grok_config_types::MemoryEmbeddingConfig>,
    ...
    search_config: cf_config::xai_grok_config_types::MemorySearchConfig,
...
impl MemoryBackendImpl {
    ...
    pub fn new(db_path: PathBuf, storage: MemoryStorage) -> Self {
        Self {
            ...
            embed_api_key: None,
            search_config: cf_config::xai_grok_config_types::MemorySearchConfig::default(),
            watcher: None,
            stale_claim_secs: 60,
    ...
    pub fn with_embedding(
        mut self,
        config: cf_config::xai_grok_config_types::MemoryEmbeddingConfig,
        base_url: String,
    ...
    pub fn with_search_config(mut self, config: cf_config::xai_grok_config_types::MemorySearchConfig) -> Self {
    ...
    fn open_readonly(&self) -> Result<rusqlite::Connection, rusqlite::Error> {
        ...
        cf_sqlite_journal::JournalMode::for_db_path(&self.db_path).open_readonly(&self.db_path)
    }
...
impl MemoryBackendImpl {
    ...
    pub fn search_config_for_test(&self) -> &cf_config::xai_grok_config_types::MemorySearchConfig {
        &self.search_config
    }
}
...
impl MemoryBackend for MemoryBackendImpl {
    ...
    async fn search(
        ...
        if needs_release {
            ...
            if let Some((dirty_count, reindexed_count, sync_start)) = watcher_sync_stats {
                cf_telemetry::session_ctx::log_event(
                    cf_telemetry::memory_telemetry::MemoryWatcherSync {
        ...
        if results.is_empty() {
            cf_telemetry::session_ctx::log_event(
                cf_telemetry::memory_telemetry::MemorySearchEmpty {
                    session_id: self.session_id.clone(),
            ...
            cf_telemetry::session_ctx::log_event(
                cf_telemetry::memory_telemetry::MemorySearch {
                    session_id: self.session_id.clone(),
                    query_length: query.len(),
                    keyword_count,
...
mod factory_tests {
    ...
    use cf_config::xai_grok_config_types::{MemoryEmbeddingConfig, MemorySearchConfig};
    ...
    fn test_factory_wires_non_overridable_search_config_fields() {
        ...
        let custom_search = MemorySearchConfig {
            max_results: 7,
            mmr: cf_config::xai_grok_config_types::MmrConfig {
                enabled: true,
                lambda: 0.42,
            },
            temporal_decay: cf_config::xai_grok_config_types::TemporalDecayConfig {
                enabled: true,
                half_life_days: 14.0,
            },
            ..Default::default()
    ...
    async fn make_embedding_provider_uses_async_api_key_resolution() {
        ...
        use cf_tools::types::ApiKeyProvider;
        ...
        let probe: cf_tools::types::SharedApiKeyProvider = Arc::new(AsyncProbe {
