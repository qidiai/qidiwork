...
use cf_pager::appearance::AppearanceConfig;
use cf_pager::minimal_api;
use cf_pager::render::Renderable;
use cf_pager::scrollback::block::RenderBlock;
use cf_pager::scrollback::blocks::ToolCallBlock;
use cf_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use cf_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                cf_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
