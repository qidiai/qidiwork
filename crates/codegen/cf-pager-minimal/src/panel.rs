...
use cf_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use cf_pager::views::modal::ActiveModal;
use cf_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use ratatui::layout::Rect;
    use cf_pager::views::extensions_modal::ExtensionsModalState;
    use cf_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    ...
    fn session_entry(id: &str) -> cf_pager::app::app_view::SessionPickerEntry {
        cf_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<cf_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: cf_pager::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: cf_pager::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a
