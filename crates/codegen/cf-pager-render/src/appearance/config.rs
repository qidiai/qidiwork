...
pub struct AnimationConfig {
    ...
    /// Also enabled by the `QIDI_FPS=1` env var. Default: false.
    pub show_fps: bool,
}
...
pub struct RawAnimationConfig {
    ...
    /// Requires a debug build. Also enabled by QIDI_FPS=1 env var. Default: false.
    pub show_fps: bool,
}
...
pub fn persist_respect_manual_folds(enabled: bool) -> std::io::Result<()> {
    ...
    if cf_config::user_grok_home().is_none() {
