...
//!
//! In dev mode, watches ~/.qidi/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.qidi/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.qidi/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = cf_config::user_grok_home()
