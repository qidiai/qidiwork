...
//! frame diff (see `cf_ratatui_inline::Terminal::flush_with_links`).
...
/// session media lives under `~/.qidi/sessions/%2F…/images/1.jpg`.
...
/// Relative file path (`images/1.png`, `.qidi/x.txt`) — one or more `/`-joined
...
/// media lives at `~/.qidi/sessions/%2F…/images/1.jpg`, which wraps in
...
mod tests {
    ...
    fn scan_detects_grok_session_media_path() {
        ...
        let line = make_line("Saved to /Users/alice/.qidi/sessions/%2Fabc/00000000/images/1.jpg.");
        let mut overlay = LinkOverlay::new();
        scan_unjoined(std::iter::once((0, &line)), 0, &[], &mut overlay);
        ...
        assert_eq!(
            ...
            "file:///Users/alice/.qidi/sessions/%252Fabc/00000000/images/1.jpg",
        );
    }
    ...
    fn scan_detects_media_path_soft_wrapped_across_rows() {
        ...
        let row0 =
            make_line("Image generated and saved to /Users/alice/.qidi/sessions/%2FUsers%2Fali");
        ...
        let expected_url = "file:///Users/alice/.qidi/sessions/%252FUsers%252Fali\
        ...
        assert_eq!(
            ...
            2 + UnicodeWidthStr::width(
                "Image generated and saved to /Users/alice/.qidi/sessions/%2FUsers%2Fali"
            ) as u16
        );
    ...
    fn scan_wrapped_path_trailing_sentence_period_excluded() {
        ...
        let row0 = make_line("Saved to /Users/me/.qidi/sessions/%2Fabc/019f3a86/ima");
        ...
        for link in overlay.links() {
            assert_eq!(
                &*link.url,
                "file:///Users/me/.qidi/sessions/%252Fabc/019f3a86/images/1.jpg"
            );
        }
    ...
    fn scan_relative_path_not_partially_linkified() {
        // A relative path like `crates/codegen/qidi-code/src/render` should
        // NOT produce a link for the `/qidi-code/src/render` substring.
        let line = make_line("find crates/codegen/qidi-code/src/render -name '*.rs'");
        let mut overlay = LinkOverlay::new();
        scan_unjoined(std::iter::once((0, &line)), 0, &[], &mut overlay);
