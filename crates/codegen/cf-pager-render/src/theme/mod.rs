...
impl Theme {
    ...
    ///
    /// Reads the active theme kind (loaded from `~/.qidi/config.toml` on
    ...
    pub fn current() -> Self {
        ...
        //      (e.g., `TERM=xterm`, `TERM=ansi`, or `QIDI_FORCE_COLOR_LEVEL=basic`),
...
pub fn apply_cursor_color() {
    ...
    cf_shared::stderr::with_locked_stderr(|stderr| {
