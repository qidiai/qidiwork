...
//!
//! ```text
//! cargo bench -p qidi-code --bench edit_highlight
//! cargo bench -p qidi-code --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use cf_pager::diff::{DiffHunk, DiffLine};
use cf_pager::scrollback::blocks::tool::{
...
use cf_pager::syntax::{Syntect, get_syntect};
