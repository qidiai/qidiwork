...
1. **Global rules**: `~/.qidi/` (applies to all projects)
...
5. **Version control your rules.** Commit AGENTS.md to the repository so the whole team benefits. User-specific overrides belong in `~/.qidi/` (global rules).
