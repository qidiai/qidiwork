...
/// `QIDI_MCP_PUSH_SERVER_STATUS=0` to disable.
pub(super) fn push_server_status_enabled() -> bool {
    use std::sync::OnceLock;
    static ENABLED: OnceLock<bool> = OnceLock::new();
    *ENABLED.get_or_init(|| {
        cf_shell::util::config::resolve_mcp_push_server_status(
...
/// `qidi-code/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`cf_shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`cf_shell::extensions::mcp::McpServerStatusPayload`] +
/// [`cf_shell::extensions::mcp::McpServerStatus`]) instead of
...
pub(super) fn handle_mcp_server_status(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    use cf_shell::extensions::mcp::{McpServerStatus, McpServerStatusPayload, McpToolEntry};
...
/// on config reload (`crates/codegen/qidi-code/src/agent/mvp_agent.rs`
