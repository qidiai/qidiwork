...
use cf_acp_lib::AcpClientMessage;

use super::actions::Effect;
use cf_shell::extensions::notification::{
    SessionNotification, SessionUpdate as XaiSessionUpdate, is_reauthable_failure,
};
use cf_shell::tools::todo::todo_item_from_plan_entry;
use cf_workspace::permission::bash_command_splitting::BashCommandHighlights;
...
fn handle_ext_method(ext: cf_acp_lib::AcpArgs<acp::ExtRequest>, app: &mut AppView) -> bool {
