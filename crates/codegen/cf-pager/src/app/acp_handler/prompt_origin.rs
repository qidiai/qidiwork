...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    cf_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        cf_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        cf_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        cf_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        cf_shell::session::PromptOrigin::TaskCompleted { .. }
            | cf_shell::session::PromptOrigin::SubagentCompleted { .. }
            | cf_shell::session::PromptOrigin::NotificationDrain
    )
}
