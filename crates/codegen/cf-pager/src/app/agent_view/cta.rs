...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        cf_telemetry::session_ctx::log_event(cf_telemetry::events::PromptSuggestion {
            action: cf_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        cf_telemetry::session_ctx::log_event(
            cf_telemetry::events::PluginCtaConnectClicked {
        ...
        self.pending_effects
            .push(super::actions::Effect::InstallPluginFromCta {
                agent_id: self.session.id,
                session_id,
                source_url_or_path: cf_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL
                    .to_string(),
                plugin_relative_path,
            });
    }
...
mod plugin_cta_notify_tests {
    ...
    fn cta_entry(name: &str) -> cf_hooks_plugins_types::MarketplacePluginEntry {
