...
fn plugins_list_response() -> cf_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    cf_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(cf_hooks_plugins_types::PluginOrigin::UserGrok),
            ),
            test_plugin_info(
                "claude-tool",
                Some(cf_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
