            ...
            MouseEventKind::Down(MouseButton::Left) => {
                    ...
                    && !self.pos_occluded(mouse.column, mouse.row)
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        cf_telemetry::events::AnnouncementCtaSurface::Banner,
                    ));
                }
                if self
                    .plugin_cta
                        ...
                        &self.plugin_cta.phase
                {
                    ...
                    if let Err(e) = cf_shell::config::add_dismissed_plugin_cta(&plugin_id) {
                        tracing::warn!(
                    ...
                    cf_telemetry::session_ctx::log_event(
                        cf_telemetry::events::PluginCtaDismissed {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        cf_telemetry::events::AnnouncementCtaSurface::Header,
                    ));
                }
                        ...
                        if let Some(idx) = hit_idx {
                                    ...
                                    .entry_screen_area(idx, self.pane_areas.scrollback)
                            {
                                ...
                                if click_row >= url_row {
                                    ...
                                    cf_telemetry::session_ctx::log_event(cf_telemetry::events::CreditLimitUpsellClicked {
