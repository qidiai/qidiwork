...
// minimal rendering lives in the sibling `qidi-code-minimal` crate; these
...
// `qidi-code-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use cf_pager_render::{
