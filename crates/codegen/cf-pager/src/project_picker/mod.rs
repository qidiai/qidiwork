...
pub mod detection {
    pub use cf_file_utils::workspace_classifier::is_project_dir;
}
pub mod sources;
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run QIDI Code in a project directory?\n\n\
                 This gives QIDI Code full context of your codebase for better results."
                .into(),
            id: None,
            options,
