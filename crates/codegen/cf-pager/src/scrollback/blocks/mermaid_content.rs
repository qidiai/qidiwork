...
//! the generic [`CodeBlockSpan`](cf_markdown::CodeBlockSpan) API) and
...
use cf_markdown::MarkdownRenderView;
...
pub struct MermaidBlock {
    ...
    /// from [`CodeBlockSpan::body`](cf_markdown::CodeBlockSpan::body). For
    ...
    /// [`CodeBlockSpan::output_line_range`](cf_markdown::CodeBlockSpan::output_line_range).
...
) -> impl Iterator<Item = &'a cf_markdown::CodeBlockSpan> {
    view.code_blocks
        .iter()
...
/// dark. The render worker maps this to `cf_mermaid::MermaidTheme`; it
