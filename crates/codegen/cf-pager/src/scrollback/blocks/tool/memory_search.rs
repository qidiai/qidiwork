...
**File:** /root/.qidi/memory/MEMORY.md (lines 0-10)
```
## Project Conventions
...
"#;
        ...
        assert_eq!(results[0].path, "/root/.qidi/memory/MEMORY.md");
...
**File:** /root/.qidi/memory/ws/MEMORY.md (lines 1-5)
```
workspace content
```

### Result 2 (score: 0.42, source: session)
**File:** /root/.qidi/memory/ws/sessions/2026-05-01.md (lines 10-20)
```
session content
```
"#;
