...
//! `/docs web` opens https://www.qidiai.ltd in the browser.
...
/// Online docs landing page (hardcoded like other TUI deep-links; can redirect if the path moves).
pub const BUILD_DOCS_URL: &str = "https://www.qidiai.ltd";
