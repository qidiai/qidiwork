...
use cf_announcements::visible_announcements;
...
fn is_critical(a: &cf_announcements::RemoteAnnouncement) -> bool {
    a.severity.as_deref() == Some("critical")
}

fn is_promo(a: &cf_announcements::RemoteAnnouncement) -> bool {
...
fn is_live_critical(
    a: &cf_announcements::RemoteAnnouncement,
    now: chrono::DateTime<chrono::Utc>,
) -> bool {
    is_critical(a) && !cf_announcements::is_expired_at(a, now)
}
...
fn is_live_promo(
    ...
    is_promo(a) && !cf_announcements::is_expired_at(a, now)
}
...
pub fn is_dismissible(a: &cf_announcements::RemoteAnnouncement) -> bool {
...
fn is_hidden(
    ...
    is_dismissible(a) && hidden_ids.contains(&cf_announcements::announcement_hide_key(a))
}
...
fn usable_cta(a: &cf_announcements::RemoteAnnouncement) -> Option<(&str, &str)> {
...
pub(crate) fn usable_cta_caption(a: &cf_announcements::RemoteAnnouncement) -> Option<&str> {
...
fn first_critical_session_announcement<'a>(
    announcements: &'a [cf_announcements::RemoteAnnouncement],
    hidden_ids: &BTreeSet<String>,
) -> Option<&'a cf_announcements::RemoteAnnouncement> {
...
pub fn promo_cta_target<'a>(
    announcements: &'a [cf_announcements::RemoteAnnouncement],
    hidden_ids: &BTreeSet<String>,
) -> Option<(&'a cf_announcements::RemoteAnnouncement, &'a str)> {
...
pub fn session_announcement_hide_keys_at(
    ...
    visible_announcements(announcements)
        ...
        .map(cf_announcements::announcement_hide_key)
        .collect()
}
...
fn render_critical_rows(
    area: Rect,
    buf: &mut Buffer,
    ann: &cf_announcements::RemoteAnnouncement,
    hide_hovered: bool,
) -> BannerHits {
    use unicode_width::UnicodeWidthStr;
...
mod tests {
    use super::*;
    use cf_announcements::RemoteAnnouncement;
    ...
    fn promo(id: &str, message: &str, cta: Option<(&str, &str)>) -> RemoteAnnouncement {
        RemoteAnnouncement {
            ...
            cta: cta.map(|(label, url)| cf_announcements::AnnouncementCta {
    ...
    fn promo_cta_target_requires_usable_pair() {
        ...
        label_only.cta = Some(cf_announcements::AnnouncementCta {
            label: Some("Go".into()),
            url: None,
            caption: None,
        });
