...
use cf_workspace::permission::bash_command_splitting::{
...
pub struct PermissionViewState {
    ...
    pub request: cf_acp_lib::AcpArgs<acp::RequestPermissionRequest>,
    ...
    /// permissions). Imported from `qidi-code`, NOT duplicated locally.
...
mod tests {
    ...
    ///
    /// ```text
    /// PERMISSION_UI_RENDER_REVIEW=1 cargo test -p qidi-code --lib \
    ...
    fn historic_bash_fixture_path() -> std::path::PathBuf {
        // CARGO_MANIFEST_DIR = crates/codegen/qidi-code
