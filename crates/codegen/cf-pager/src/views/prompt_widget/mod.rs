...
use cf_ratatui_textarea::{ElementId, ElementKind, TextArea, TextAreaState, TextElement};
...
pub struct PromptWidget {
    ...
    hovered_image_element_id: Option<cf_ratatui_textarea::ElementId>,
    /// Image shown immediately after insertion without moving the edit cursor.
    post_insert_image_preview: Option<(cf_ratatui_textarea::ElementId, usize)>,
...
impl PromptWidget {
    ...
    fn handle_key_inner(&mut self, key: &KeyEvent) -> PromptEvent {
        ...
        if changed {
            ...
            if is_backspace_key && !old_text.is_empty() {
                use cf_telemetry::events::BackspaceNoEffect;
    ...
    pub fn handle_mouse(&mut self, mouse: &crossterm::event::MouseEvent) -> PromptEvent {
        use cf_ratatui_textarea::{MouseAction, TextElementEventKind};
    ...
    fn image_element_near_cursor(&self) -> Option<&cf_ratatui_textarea::TextElement> {
    ...
    pub fn textarea(&self) -> &cf_ratatui_textarea::TextArea {
        &self.textarea
    }
...
fn strip_all_elements(
    text: &str,
    cursor: usize,
    textarea: &cf_ratatui_textarea::TextArea,
) -> (String, usize) {
...
fn map_clean_offset_to_raw(
    text: &str,
    clean_offset: usize,
    elements: &[cf_ratatui_textarea::TextElement],
) -> usize {
    if elements.is_empty() {
