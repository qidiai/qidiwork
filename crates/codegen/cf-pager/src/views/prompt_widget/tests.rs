#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn test_image() -> PastedImage {
        PastedImage {
            element_id: cf_ratatui_textarea::ElementId::from_raw(0), // overwritten by insert_image
            display_number: 0,
    ...
    fn fuzzy_result(path: &str, is_dir: bool) -> cf_workspace::file_system::FuzzyMatchResult {
        cf_workspace::file_system::FuzzyMatchResult {
