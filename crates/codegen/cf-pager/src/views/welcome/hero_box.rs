...
const HERO_SUBTITLE: &str = "感谢使用 QIDI Code，用 /feedback 反馈！ | Thanks for trying QIDI Code, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&cf_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        pinned.cta = Some(cf_announcements::AnnouncementCta {
        ...
        dismissible.cta = Some(cf_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/grok".into()),
            caption: Some("or use Ctrl+O".into()),
        });
