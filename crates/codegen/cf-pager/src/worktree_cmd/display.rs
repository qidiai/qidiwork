...
use cf_shell::session::worktree::META_KEY_LABEL;
...
mod tests {
    ...
    fn make_test_record(metadata: Option<serde_json::Value>) -> cf_fast_worktree::WorktreeRecord {
        use cf_fast_worktree::{WorktreeKind, WorktreeRecord, WorktreeStatus};
        WorktreeRecord {
            id: "test".into(),
            path: "/tmp/wt".into(),
