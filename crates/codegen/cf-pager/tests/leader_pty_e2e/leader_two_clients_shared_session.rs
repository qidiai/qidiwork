...
#[ignore = "PTY e2e; run with cargo test -p qidi-code --test leader_pty_e2e -- --ignored --test-threads=1"]
async fn leader_two_clients_shared_session() {
    // One shared leader (shared HOME/QIDI_HOME hold the sessions AND the
