...
use cf_pager::app::mermaid_worker::render_via_subprocess;
use cf_pager::scrollback::blocks::mermaid_content::MermaidRenderQuality;
...
fn tight_timeout_kills_child_and_returns_err() {
    ...
    // `cf_mermaid::subprocess` `reap_terminates_the_process` unit test;
