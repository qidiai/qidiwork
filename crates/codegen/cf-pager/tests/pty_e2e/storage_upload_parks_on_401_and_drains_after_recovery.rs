...
async fn storage_upload_parks_on_401_and_drains_after_recovery() {
    ...
    env_refs.retain(|(k, _)| *k != "QIDI_TRACE_UPLOAD");
    env_refs.push(("QIDI_TRACE_UPLOAD", "true"));
    env_refs.push(("QIDI_TELEMETRY_TRACE_UPLOAD", "true"));
    env_refs.push(("QIDI_UPLOAD_QUEUE_AUTH_PROBE_SECS", "2"));
    ...
    //   not fire inside this 3s window; with `QIDI_UPLOAD_QUEUE_AUTH_PROBE_SECS=2`
