...
pub fn stream_responses<'a>(
    ...
    async_stream::stream! {
        ...
        let mut items = cf_sampling_types::response_to_conversation_items(response);
        cf_sampling_types::inject_streaming_reasoning_fallback(&mut items, reasoning_acc);
...
mod tests {
    ...
    async fn doom_loop_collector_signals_land_on_completed_response() {
        use cf_sampling_types::doom_loop::{
