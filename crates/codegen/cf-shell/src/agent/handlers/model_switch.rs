...
use cf_sampling_types::parse_reasoning_effort_meta;
...
pub(crate) async fn apply(
    ...
    let mut pending_rebuild_definition: Option<cf_agent::AgentDefinition> = None;
    {
        ...
        if is_mismatch && turn_count > 0 {
            ...
            cf_telemetry::session_ctx::log_event(cf_telemetry::events::ModelSwitched {
        ...
        if is_mismatch && turn_count == 0 {
            ...
            let resolved = cf_agent::discovery::by_name_in_cwd_with_plugins(
                required,
                cwd,
        ...
        match rebuild_result {
            ...
            Err(e) => {
                ...
                cf_telemetry::session_ctx::log_event(
                    cf_telemetry::events::ModelSwitched {
                        session_id: session_id.0.to_string(),
                        previous_model_id: previous_model_id.to_string(),
                        new_model_id: model_id.0.to_string(),
                        success: false,
