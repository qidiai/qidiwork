        ...
        .run_until(async {
            ...
            let (permission_handle, _events_rx) =
                cf_workspace::permission::spawn_permission_manager(
                    ...
                    gateway,
                    cwd,
                    cf_workspace::permission::types::ClientType::Generic,
            ...
            for access in [
                cf_workspace::permission::AccessKind::Read(Some(".env".into())),
                cf_workspace::permission::AccessKind::Bash("cat .env".into()),
            ] {
                ...
                assert!(
                    matches!(
                        decision,
                        cf_workspace::permission::Decision::PolicyDeny(_)
                    ),
