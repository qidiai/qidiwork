...
//
// State is persisted to `~/.qidi/claude_import_state.json`.
...
use cf_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.qidi/claude_import_state.json`.
