...
//!
//! Repairs via [`cf_chat_state::compaction_utils::repair_history`]. Resident
...
use cf_chat_state::compaction_utils::HistoryRepairReport;
...
async fn repair_on_disk(grok_root: &std::path::Path, session_id: &str, dry_run: bool) -> ExtResult {
    ...
    let report = cf_chat_state::compaction_utils::repair_history(&mut chat_history);
