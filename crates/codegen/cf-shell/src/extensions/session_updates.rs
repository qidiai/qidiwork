...
mod tests {
    ...
    fn dummy_gateway() -> cf_acp_lib::AcpAgentGatewaySender {
    ...
    fn capturing_gateway() -> (
        cf_acp_lib::AcpAgentGatewaySender,
        tokio::sync::mpsc::UnboundedReceiver<cf_acp_lib::AcpClientMessage>,
    ) {
        let (tx, rx) = tokio::sync::mpsc::unbounded_channel();
        (cf_acp_lib::AcpAgentGatewaySender::new(tx), rx)
    }
    ...
    fn cf_rewind(target: usize) -> String {
        format!(
