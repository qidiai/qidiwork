...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "x.ai/skills/add" => {
            ...
            .await
            {
                cf_telemetry::session_ctx::log_event(
                    cf_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            cf_telemetry::session_ctx::log_event(cf_telemetry::events::SkillAdded {
        ...
        "x.ai/skills/remove" => {
            ...
            {
                cf_telemetry::session_ctx::log_event(
                    cf_telemetry::events::SkillRemoved { success: false },
                );
            ...
            cf_telemetry::session_ctx::log_event(cf_telemetry::events::SkillRemoved {
                success: true,
            });
