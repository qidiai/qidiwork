...
const WORKTREE_EXT_LOG: &str = "cf_worktree";
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "x.ai/git/worktree/create_from_worktree" => {
            ...
            let result = ops
                .dispatch(
                    &cf_workspace::workspace_ops::PrepareWorktreeFromWorktreeReq {
                        inner: req.clone(),
                    },
                    None,
                )
        ...
        "x.ai/git/worktree/create_from_worktree_sync" => {
            ...
            let resolved_root = ops
                .dispatch(
                    &cf_workspace::workspace_ops::GitResolveRootReq {
            ...
            if let Some(git_root) = resolved_root {
                let vcs_kind = ops
                    .dispatch(
                        &cf_workspace::workspace_ops::DetectVcsKindReq {
                            path: git_root.clone(),
                        },
                        None,
                    )
                    .await
                    .unwrap_or(cf_workspace::session::git::VcsKind::Git);
                if vcs_kind.is_jj() {
            ...
            let result = ops
                .dispatch(
                    &cf_workspace::workspace_ops::CreateWorktreeFromWorktreeSyncReq {
                        inner: req.into_wire(),
                    },
                    None,
                )
        ...
        "x.ai/git/worktree/resume_session" => {
            ...
            let agent_id = cf_telemetry::id::agent_id();
        ...
        "x.ai/git/worktree/list" => {
            let req: cf_workspace::workspace_ops::WorktreeListReq =
        ...
        "x.ai/git/worktree/show" => {
            ...
            let op = cf_workspace::workspace_ops::WorktreeShowReq {
        ...
        "x.ai/git/worktree/gc" => {
            ...
            let op = cf_workspace::workspace_ops::WorktreeGcReq {
                dry_run: req.dry_run,
                max_age_secs,
                force: req.force,
            };
        ...
        "x.ai/git/worktree/db/stats" => {
            let result = ops
                .dispatch(
                    &cf_workspace::workspace_ops::WorktreeDbStatsReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "x.ai/git/worktree/db/rebuild" => {
            let result = ops
                .dispatch(
                    &cf_workspace::workspace_ops::WorktreeDbRebuildReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "x.ai/git/worktree/db/path" => {
            let result = ops
                .dispatch(
                    &cf_workspace::workspace_ops::WorktreeDbPathReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
...
mod tests {
    ...
    fn db_path_response_serializes() {
        let resp = WorktreeDbPathResponse {
            path: "/home/user/.qidi/worktrees.db".into(),
        };
        let json = serde_json::to_string(&resp).unwrap();
        assert!(json.contains("\"path\":\"/home/user/.qidi/worktrees.db\""));
    }
