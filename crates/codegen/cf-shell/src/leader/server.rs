...
use cf_computer_hub_sdk::{AuthCredential, AuthIdentity, AuthProvider};
use cf_workspace::WorkspaceHandle;
...
const PROD_COMPUTER_HUB_URL: &str = "wss://qidiwork.qidiai.ltd/v1/tools";
...
async fn handle_workspace_start(
    ...
    let upload_queue_enabled =
        std::env::var("QIDI_WORKSPACE_UPLOAD_QUEUE_ENABLED").as_deref() != Ok("false");
    ...
    let handle = cf_workspace::connect_local_workspace(
        cwd_path.clone(),
        url,
        auth,
        Some(metadata),
...
pub async fn run_leader_server(
    ...
    loop {
        tokio::select! {
            ...
            cf_telemetry::unified_log::info("leader.client.registered", None,
            ...
            cf_telemetry::unified_log::info("leader.client.disconnected", None,
            ...
            cf_telemetry::unified_log::warn("leader.response.orphaned", None,
            ...
            cf_telemetry::unified_log::warn("leader.response.send_failed", None,
