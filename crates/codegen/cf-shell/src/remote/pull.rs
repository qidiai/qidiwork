...
pub(crate) mod hydrate {
    ...
    // Shared conversation reducer (extracted from this module; the local
    // verification path reuses the same fold as pull hydration).
    use crate::session::storage::reducer::ChatReducer;
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            sandbox_profile: cf_sandbox::configured_profile_name().map(String::from),
