...
async fn already_reported(actor: &SessionActor, task_id: &str) -> bool {
    use cf_tools::reminders::task_completion::ReportedTaskCompletions;
...
struct OneTaskTerminal {
    tasks: Vec<cf_tools::computer::types::TaskSnapshot>,
}
#[async_trait::async_trait]
impl cf_tools::computer::types::TerminalBackend for OneTaskTerminal {
    async fn run(
        &self,
        _: cf_tools::computer::types::TerminalRunRequest,
    ) -> Result<
        cf_tools::computer::types::TerminalRunResult,
        cf_tools::computer::types::ComputerError,
    > {
        unimplemented!()
    }
    ...
    async fn get_task(&self, _: &str) -> Option<cf_tools::computer::types::TaskSnapshot> {
        None
    }
    async fn kill_task(&self, _: &str) -> cf_tools::computer::types::KillOutcome {
        cf_tools::computer::types::KillOutcome::NotFound
    }
    async fn wait_for_completion(
        &self,
        _: &str,
        _: Option<std::time::Duration>,
    ) -> Option<cf_tools::computer::types::TaskSnapshot> {
        None
    }
    async fn list_tasks(&self) -> Vec<cf_tools::computer::types::TaskSnapshot> {
        self.tasks.clone()
    }
}
fn completed_bash_task(id: &str) -> cf_tools::computer::types::TaskSnapshot {
    cf_tools::computer::types::TaskSnapshot {
        task_id: id.into(),
