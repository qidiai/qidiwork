            ...
            *actor.client_hooks.borrow_mut() = client_hooks;
            ...
            tokio::task::spawn_local(async move {
                while let Some(msg) = gateway_rx.recv().await {
                    match msg {
                        cf_acp_lib::AcpClientMessage::ExtMethod(args) => {
                        ...
                        cf_acp_lib::AcpClientMessage::SessionNotification(args) => {
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_tools(vec![
                cf_tools::registry::types::ToolConfig::for_tool::<
                    cf_tools::implementations::use_tool::UseTool,
                >(),
            ])
            .await;
            ...
            client_hooks.insert(
                ...
                vec![crate::extensions::hooks::ClientHookGroup {
                    matcher: Some(
                        cf_hooks::matcher::HookMatcher::new("linear__save_issue").unwrap(),
                    ),
                    callback_ids: vec!["cb_0".to_string()],
                    timeout: None,
                }],
