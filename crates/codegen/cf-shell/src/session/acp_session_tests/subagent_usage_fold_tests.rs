...
fn usage_rows() -> Vec<(String, cf_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        cf_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use cf_tools::implementations::qidi_build::task::types::SubagentOutstandingReply;
...
> {
    use cf_tools::implementations::qidi_build::task::types::SubagentEvent;
