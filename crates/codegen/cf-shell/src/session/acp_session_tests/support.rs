...
#[cfg(test)]
pub(crate) fn noop_observability_bridge() -> cf_computer_hub_sdk::ObservabilityBridge {
    cf_computer_hub_sdk::ObservabilityBridge::new(
        None,
        cf_tool_protocol::SessionId::new("test").expect("valid"),
    )
}
#[cfg(test)]
pub(crate) async fn test_agent_default() -> cf_agent::Agent {
...
pub(crate) async fn test_agent_with_tools(
    tools: Vec<cf_tools::registry::types::ToolConfig>,
) -> cf_agent::Agent {
...
async fn test_agent_from_config(
    ...
    cf_agent::Agent::new(
        definition,
        cf_agent::PromptContext::default(),
        String::new(),
        tool_bridge,
...
pub(crate) async fn create_test_actor_ex(
    ...
    gateway_tx: tokio::sync::mpsc::UnboundedSender<cf_acp_lib::AcpClientMessage>,
    ...
    let actor = SessionActor {
        ...
        permissions: cf_workspace::permission::PermissionHandle::allow_all(),
        tool_context,
