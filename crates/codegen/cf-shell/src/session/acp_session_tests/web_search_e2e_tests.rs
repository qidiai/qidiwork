...
use cf_tools::registry::types::{SessionContext, ToolConfig, ToolServerConfig};
...
async fn web_search_uses_model_override_from_config_end_to_end() {
    ...
    let ctx = SessionContext {
        ...
        memory_backend: None,
        web_search_config: cf_tools::implementations::web_search::WebSearchConfig::Enabled {
...
async fn web_search_errors_when_configured_model_cannot_be_resolved() {
    ...
    let ctx = SessionContext {
        ...
        memory_backend: None,
        web_search_config: cf_tools::implementations::web_search::WebSearchConfig::Disabled,
        web_fetch_config: Default::default(),
        lsp: None,
        image_gen_config: Default::default(),
        video_gen_config: Default::default(),
