...
//! shell-specific types (`cf_tools::MemoryBackend`, memory context).
//!
//! The core [`CompactionStateContext`] struct and its builder live in
//! `cf_chat_state::compaction_utils`. This module adds system-reminder
...
//! [`cf_compaction::reminder`] so grok-chat and cf-tools stay in lockstep.
...
pub fn to_system_reminder_sync(
    ...
    skills: &[cf_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[cf_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn cf_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[cf_tools::implementations::skills::types::SkillInfo],
    memory_results: &[cf_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        cf_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use cf_tools::implementations::search_tool::format_compaction_server_line;
