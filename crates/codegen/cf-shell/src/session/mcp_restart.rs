...
//! window containing a [`cf_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`cf_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`cf_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`cf_mcp::servers::ClientStateKind::Empty`]
...
use cf_mcp::servers::{McpClientEventKind, McpServerName};
