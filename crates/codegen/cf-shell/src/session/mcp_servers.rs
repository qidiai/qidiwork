...
use cf_mcp::oauth_config::{McpOAuthConfig, McpOAuthConfigMap};
use cf_mcp::servers as inner;
...
pub fn build_config_resolved_event(
    ...
    let servers = configs
        ...
        .collect();
    cf_file_utils::events::Event::McpConfigResolved { servers, disabled }
}
