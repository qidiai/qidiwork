...
//!
//! Canonical definitions live in `cf_prompt_queue`; this re-export keeps every existing
//! `crate::session::prompt_queue::*` and cross-crate `cf_shell::session::prompt_queue::*`
//! path resolving without edits.

pub use cf_prompt_queue::{QueueChanged, QueueEntryMeta, QueueEntryWire};
