...
pub use cf_chat_state::compaction_utils::extract_user_query;
...
pub async fn compute_vcs_status_block(
    ...
    use cf_workspace::file_system::{git_status, jj_status};
...
// Tests for extract_user_query now live in cf_chat_state::compaction_utils.

#[cfg(test)]
mod tests {
    use super::*;
    use cf_workspace::file_system::FsError;
