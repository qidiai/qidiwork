//! AcpTerminalAdapter: implements `qidi-code::TerminalBackend` using ACP gateway calls.
//!
//! This adapter enables bash tool execution over ACP (remote execution).
//! It translates qidi-code' `TerminalBackend` trait into ACP protocol calls:
...
/// Wraps qidi-code's ACP gateway to satisfy qidi-code' TerminalBackend.
