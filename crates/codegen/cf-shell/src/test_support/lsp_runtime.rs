...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(cf_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: cf_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: cf_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: cf_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl cf_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &cf_tools::implementations::lsp::LspToolInput,
    ) -> cf_tools::implementations::lsp::LspToolResult {
        cf_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<cf_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<cf_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
