//! Retry utilities — re-exported from `qidi-code`.
//!
//! The canonical implementation now lives in `cf_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use cf_tools::retry::BackoffConfig as RetryConfig;
pub use cf_tools::retry::{BackoffConfig, execute_with_backoff};
