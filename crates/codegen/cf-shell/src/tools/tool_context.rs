...
//! qidi-code. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use cf_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use cf_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn cf_tools::implementations::lsp::LspBackend>>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = cf_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
