...
use cf_config::xai_grok_config_types::DisplayRefreshSettings;

pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "QIDI_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "QIDI_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`QIDI_MIN_DRAW_MS` / `QIDI_SCROLL_CADENCE_MS`).
