pub const ENV_SYSTEM_PROMPT_LABEL: &str = "QIDI_SYSTEM_PROMPT_LABEL";

pub const DEFAULT_SYSTEM_PROMPT_LABEL: &str = cf_agent::DEFAULT_SYSTEM_PROMPT_LABEL;
...
mod system_prompt_label_tests {
    ...
    /// Serialize access to `QIDI_SYSTEM_PROMPT_LABEL` and clear it for tier tests.
