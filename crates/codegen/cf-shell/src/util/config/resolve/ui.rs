...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "QIDI_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`QIDI_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "QIDI_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`QIDI_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "QIDI_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`QIDI_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `QIDI_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("QIDI_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes QIDI_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
