...
use cf_hooks::discovery::HookSource;
...
pub fn discover_hook_source_paths(
    ...
    // sources. Native .qidi/hooks/ directories are still scanned (they hold
...
pub fn discover_hooks(
    ...
    cf_hooks::discovery::HookRegistry,
    Vec<cf_hooks::error::HookError>,
) {
