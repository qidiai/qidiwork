//! Shared helpers for qidi-code integration tests.

use cf_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `cf_sampler::SamplingClient`, which takes a
