...
//! binary shares one process-global `QIDI_HOME`, process env, and key override.
...
pub fn signed_team_body(
    ...
    let payload = SignedPayload {
        ...
        fail_closed: requirements.is_some_and(cf_config::fail_closed_flag_from_str),
...
pub fn team_identity(id: &str) -> cf_shell::config::ServingIdentity {
    cf_shell::config::ServingIdentity::Team(id.to_owned())
}
