...
//! `cf_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `qidi-code` (on `SubagentsConfig`):
...
"#;
        ...
        assert_eq!(
            ...
            Some(".qidi/prompts/researcher.md")
        );
