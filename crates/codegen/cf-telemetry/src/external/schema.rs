...
/// Built-in tool names (closed enum surface in `qidi-code`) that pass
...
fn tool_outcome_label(o: &cf_file_utils::events::types::ToolOutcome) -> &'static str {
    use cf_file_utils::events::types::ToolOutcome;
    match o {
