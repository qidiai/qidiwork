...
impl TraceUploadReason {
    ...
    pub fn from_upload_method(method: &Option<cf_file_utils::UploadMethod>) -> Self {
        match method {
            Some(cf_file_utils::UploadMethod::Proxy { .. }) => Self::Proxy,
            Some(cf_file_utils::UploadMethod::S3 { .. }) => Self::DirectS3,
            Some(cf_file_utils::UploadMethod::Direct { .. }) => Self::DirectGcs,
...
#[cfg(test)]
mod tests {
    use cf_file_utils::UploadMethod;
