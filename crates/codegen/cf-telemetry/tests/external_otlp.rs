...
fn external_stream_end_to_end() {
    ...
    let mut cfg = cf_telemetry::external::ExternalOtelConfig::resolve_with(
        |name| match name {
            "QIDI_EXTERNAL_OTEL" => Some("1".into()),
    ...
    cfg.client = cf_telemetry::external::config::ExternalClientInfo {
        service_version: "0.0.0-test".into(),
        client_version: "0.0.0-test".into(),
        app_entrypoint: "cli".into(),
    };

    cf_telemetry::external::init(Some(cfg));
    assert!(cf_telemetry::external::is_active());
    ...
    assert!(!cf_telemetry::is_enabled());
    cf_telemetry::log_event(cf_telemetry::events::SessionNew {
        session_id: "sess-int-1".into(),
        client_identifier: None,
        client_version: None,
        is_git_repo: true,
        permission_mode: cf_telemetry::enums::PermissionMode::Ask,
    });
    cf_telemetry::log_event(cf_telemetry::events::SessionHarness {
        session_id: "sess-int-1".into(),
        client_identifier: Some("grok-pager".into()),
        model_id: "grok-4".into(),
        agent_name: "cf-tools-plan".into(),
        permission_mode: cf_telemetry::enums::PermissionMode::Ask,
    ...
    cf_telemetry::log_event(cf_telemetry::events::PromptSubmitted {
    ...
    cf_telemetry::log_event(cf_telemetry::events::ModelResponseReceived {
    ...
    cf_telemetry::external::shutdown();
    assert!(
