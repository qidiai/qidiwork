...
use cf_telemetry::external::{self, ExternalOtelRemotePolicy, IdentityAttrs};
...
fn external_stream_gates_on_end_to_end() {
    ...
    cf_telemetry::log_event(cf_telemetry::events::ToolCallCompleted {
        tool_name: "github__create_issue".into(),
        outcome: cf_file_utils::events::types::ToolOutcome::Success,
        duration_ms: 12,
