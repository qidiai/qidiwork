...
impl cf_tool_runtime::Tool for MemoryGetImpl {
    type Args = MemoryGetInput;
    type Output = ToolOutput;

    fn id(&self) -> cf_tool_protocol::ToolId {
        cf_tool_protocol::ToolId::new("memory_get").expect("valid tool id")
    }
        ...
        let content = memory
            ...
            .map_err(|e| {
                cf_tool_runtime::ToolError::execution(
                    cf_tool_protocol::ToolId::new("memory_get").expect("valid"),
