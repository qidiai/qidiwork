...
impl cf_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> cf_tool_protocol::ToolId {
        cf_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                cf_tool_runtime::ToolError::execution(
                    cf_tool_protocol::ToolId::new("memory_search").expect("valid"),
