...
impl cf_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl cf_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> cf_tool_protocol::ToolId {
        cf_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, cf_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                cf_tool_runtime::ToolError::execution(
                    cf_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
