...
use crate::implementations::qidi_build::bash::{
...
impl cf_tool_runtime::Tool for BashConciseTool {
    ...
    async fn run(
        ...
        let result = cf_tool_runtime::Tool::run(&BashTool, ctx, input).await?;
...
mod tests {
    ...
    fn no_double_header_after_default_prebake() {
        ...
        bash.output_for_prompt =
            crate::implementations::qidi_build::bash::format_default_prompt(&bash);
