...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::QidiBuildConcise
    }
...
impl cf_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // QidiBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::qidi_build::read_file::ReadFileTool;
