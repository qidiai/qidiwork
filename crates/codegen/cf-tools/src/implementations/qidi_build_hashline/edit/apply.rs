...
use crate::implementations::qidi_build_hashline::read_file::format_hashline_content;
use crate::implementations::qidi_build_hashline::scheme::{
...
mod tests {
    ...
    use crate::implementations::qidi_build_hashline::config::HashlineSchemeParams;
    use crate::implementations::qidi_build_hashline::scheme::{ChunkFingerprint, ContentOnly};
