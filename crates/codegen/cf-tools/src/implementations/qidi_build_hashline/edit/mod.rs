...
impl crate::types::tool_metadata::ToolMetadata for HashlineEditTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::QidiBuildHashline
    }
...
impl cf_tool_runtime::Tool for HashlineEditTool {
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, cf_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<cf_tool_runtime::Cwd>() {
            ...
            let scheme = params
                .0
                .build_scheme()
                .map_err(cf_tool_runtime::ToolError::invalid_arguments)?;
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::qidi_build_hashline::anchor::split_lines;
        use crate::implementations::qidi_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::qidi_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    async fn output_is_tool_output_search_replace() {
        ...
        let result: crate::types::output::SearchReplaceOutput =
            cf_tool_runtime::Tool::run(&tool, test_ctx(resources.into_shared()), input)
                .await
                .unwrap();
    ...
    fn test_scheme() -> Box<dyn crate::implementations::qidi_build_hashline::scheme::AnchorScheme> {
        crate::implementations::qidi_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
