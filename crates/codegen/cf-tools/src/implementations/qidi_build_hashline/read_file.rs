...
//!
//! Reuses the core file-reading logic from [`qidi_build::read_file::run_read_file`]
...
use crate::implementations::qidi_build::read_file::{ReadFileInput, run_read_file};
...
impl cf_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> cf_tool_protocol::ToolId {
        cf_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::qidi_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    fn tool_metadata() {
        ...
        assert_eq!(cf_tool_runtime::Tool::id(&tool).as_str(), "hashline_read");
    ...
    /// file content independently of qidi_build `read_file`).
    #[tokio::test]
