...
//! Run:
//! ```bash
//! cargo test -p qidi-code --test path_suggestions_production
//! ```

use std::path::PathBuf;
use tempfile::TempDir;
use cf_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &cf_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
