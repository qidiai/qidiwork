//! Installed QIDI Code CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "QIDI_TEST_VERSION";

pub const VERSION: &str = match option_env!("QIDI_VERSION") {
    Some(v) => v,
