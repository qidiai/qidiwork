//! Wire types for the `qidi-code` API.
//!
...
//! `qidi-code-grpc` crate. The Rust types defined here are
//! the source of truth.
...
///
/// Lives in `qidi-code-types` (instead of `qidi-code` or
...
/// rmcp into each other. Re-exported by `cf_workspace::permission`
