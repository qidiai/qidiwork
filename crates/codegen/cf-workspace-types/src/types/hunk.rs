...
//!
//! TODO(workspace): align with `cf_hunk_tracker::Hunk` and
//! `cf_hunk_tracker::HunkAction` when the hunk tracker's wire surface
...
///
/// TODO(workspace): align with `cf_hunk_tracker::types::Hunk`.
...
///
/// TODO(workspace): align with `cf_hunk_tracker::types::HunkAction`.
///
