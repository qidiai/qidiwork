...
// its wire types live in `cf_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use cf_workspace_types::rpc::fs::FsReadEncoding;
...
pub use cf_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
...
impl Serialize for FuzzyMatchResult {
        ...
        S: serde::Serializer,
    {
        ...
        let name: Cow<'_, str> = std::path::Path::new(&path_str)
            .file_name()
