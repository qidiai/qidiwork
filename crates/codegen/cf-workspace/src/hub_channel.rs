...
pub fn extract_workspace_event(
    frame: &cf_tool_protocol::ToolNotificationFrame,
) -> Option<WorkspaceEvent> {
    use cf_tool_protocol::WireToolNotification;
...
mod tests {
    use super::*;
    use cf_tool_protocol::{ToolId, ToolNotificationFrame, WireToolNotification};
    ...
    // consume_stream_terminal tests live in qidi-code-client.
}
