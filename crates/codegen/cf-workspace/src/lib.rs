...
pub use cf_workspace_types::WorkspaceEvent;
pub use cf_hunk_tracker::HunkTrackerHandle;
...
/// environment (`QIDI_HOME`, `HOME`, …). nextest isolates each test in its own
...
/// can clobber `QIDI_HOME` mid-test. A single shared lock (used by every
