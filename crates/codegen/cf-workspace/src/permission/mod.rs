...
pub use auto_mode::{
    ...
    ClassifierMessageRole, ClassifierPromptType, ClassifierTurn, ClassifierVerdict,
    ClassifyTextChannel, ClassifyTextFn, FixedClassifier, HeuristicPermissionClassifier,
    LlmPermissionClassifier, PermissionClassifier, SharedClassifier,
