...
///        `~/.qidi/config.toml` via the `Effect::PersistPermissionMode` effect
...
/// Canonical definition lives in `cf_workspace_types` (so both the
...
/// reached `crate::permission::MCP_TOOL_NAME_DELIMITER`.
