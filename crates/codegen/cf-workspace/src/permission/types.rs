...
impl From<&cf_tools::types::ToolInput> for AccessKind {
    fn from(input: &cf_tools::types::ToolInput) -> Self {
...
pub enum RequirementSource {
    Unknown,
    /// User-writable `~/.qidi/requirements.toml` — untrusted for keeping a
...
mod tests {
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use cf_tools::implementations::use_tool::UseToolInput;
        use cf_tools::types::ToolInput;
