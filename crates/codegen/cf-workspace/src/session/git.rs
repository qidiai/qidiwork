...
pub const RESTORE_CODE_LOG: &str = "cf_restore_code";
...
///
/// 1. `supplied_cwd` is a grok-managed worktree (`~/.qidi/worktrees/...`).
...
pub fn restore_code_checkout_allowed(supplied_cwd: &Path, persisted_cwd: Option<&str>) -> bool {
    let worktrees_dir = cf_tools::util::grok_home::grok_home().join("worktrees");
...
const REWIND_GIT_ENV: &str = "QIDI_WORKSPACE_REWIND_GIT";
...
pub fn git_rewind_enabled() -> bool {
    cf_config::env_bool(REWIND_GIT_ENV).unwrap_or(false)
}
...
mod tests {
    ...
    fn test_effective_worktree_cwd_empty_offset() {
        let result =
            effective_worktree_cwd("/home/user/.qidi/worktrees/repo/ab-123-a", Path::new(""));
        assert_eq!(result, "/home/user/.qidi/worktrees/repo/ab-123-a");
    }
    #[test]
...
mod restore_code_tests {
    ...
    fn restore_code_checkout_allowed_worktree_cwd_is_allowed() {
        let worktrees = Path::new("/home/u/.qidi/worktrees");
        assert!(restore_code_checkout_allowed_in(
            Path::new("/home/u/.qidi/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            Some("/home/u/repo"),
            worktrees,
        ));
    }
    ...
    fn restore_code_checkout_allowed_source_repo_with_worktree_session_is_refused() {
        ...
        assert!(!restore_code_checkout_allowed_in(
            Path::new("/home/u/repo"),
            Some("/home/u/.qidi/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            worktrees,
        ));
    }
    #[test]
