...
/// [`AuthIdentity`](cf_computer_hub_sdk::AuthIdentity). The two types carry the
...
impl From<cf_computer_hub_sdk::AuthIdentity> for WorkspaceIdentity {
    fn from(id: cf_computer_hub_sdk::AuthIdentity) -> Self {
...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `qidi-code` crate that produced the record.
    ...
    /// Sandbox profile name (`$QIDI_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("QIDI_SANDBOX_PROFILE").ok(),
            cf_sandbox::is_inside_bwrap(),
