...
use cf_file_utils::gcs::StorageConfig;
use cf_file_utils::queue::{EnqueueOutcome, TraceExportSource, UploadQueue};
use cf_file_utils::storage_client::Auth401AttributionCallback;
use cf_file_utils::{TraceExportConfig, UploadMethod};
use cf_auth::{AuthCredentialProvider, CredentialSnapshot};
...
impl cf_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
mod tests {
    use super::*;
    use cf_computer_hub_sdk::auth::AuthCredential;
