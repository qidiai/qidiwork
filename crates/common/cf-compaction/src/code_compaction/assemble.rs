//! Compacted-history assembly (cf-tools's rebuild structure, generic).
//!
...
//! ```
//!
//! cf-tools is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // cf-tools keeps the legacy `<user_query>`-wrapped continuation text and
