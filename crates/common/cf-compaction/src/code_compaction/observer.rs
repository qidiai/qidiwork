//! Observability seam for the full-replace (cf-tools) pass.
//!
//! The shared orchestrator reports per-attempt and terminal outcomes through
//! this trait so each harness can emit its own telemetry (cf-tools:
...
//!
//! Emission points are part of the behavior contract: the cf-tools observer
