...
fn map_block(block: cf_tool_protocol::McpBlock) -> ContentBlock {
    use cf_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: cf_tool_protocol::JsonRpcError) -> ToolError {
