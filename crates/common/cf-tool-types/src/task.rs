...
/// A built-in subagent type shared by the CLI (`qidi-code`) and other
...
impl BuiltinSubagent {
    ...
    pub fn render_tools(&self, naming: &SubagentToolNaming<'_>) -> String {
    ...
    pub fn to_descriptor(&self, naming: &SubagentToolNaming<'_>) -> SubagentDescriptor {
        SubagentDescriptor {
...
pub fn build_task_description(subagents: &[SubagentDescriptor], naming: &TaskToolNaming<'_>) -> String {
...
pub fn build_kill_task_description(naming: &KillTaskToolNaming<'_>) -> String {
...
pub fn build_task_output_description(naming: &TaskOutputToolNaming<'_>) -> String {
...
pub fn build_wait_tasks_description(naming: &WaitTasksToolNaming<'_>) -> String {
...
mod tests {
    ...
    // cf-tools toolset (monitor + task + bash + read present, POSIX). The
